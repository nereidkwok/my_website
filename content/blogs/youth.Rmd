...
description: Understanding the standard workflow for performing hypothesis tests with youth risk behavior surveillance data.
draft: false
image: picyouth.jpeg
keywords: ""
slug: youth
...
## Relationship between high schooler’s weight and physical activity

Create a new variable in the dataframe `yrbss`, called `physical_3plus` , which will be `yes` if they are physically active for at least 3 days a week, and `no` otherwise. Calculate the number and % of those who are and are not active for more than 3 days.
```{r}
yrbss %>%
